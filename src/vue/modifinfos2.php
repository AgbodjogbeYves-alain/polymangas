        ...
        <form class="col s9" method="POST" action="../controller/modifinfos.php">
          <div class="row">
            <div class="input-field col s9" >
              <input id="first_name" type="text" class="validate" required name="nom1" pattern='.{0,20}'>
              <label class="active" for="first_name">First Name</label>
            </div>
          </div>
          <div class="row">
            <div class="input-field col s9">
                <input id="last_name" type="text" class="validate" required name="prenom1" pattern='.{0,20}'>
                <label class="active" for="last_name">Last Name</label>
            </div>
          </div> 
          <div class="row">
            <div class="input-field col s9">
                <input id="pseudo" type="text" class="validate" required name="pseudo1" pattern='.{0,20}'>
          ...
          <div class="row">
           ...
           <div class="row">
          <div class="input-field col s9">
              <input id="numrue" type="number" required name="numrue1" min="1" class="validate">
